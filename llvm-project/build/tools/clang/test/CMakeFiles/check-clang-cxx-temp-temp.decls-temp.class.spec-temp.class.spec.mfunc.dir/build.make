...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class.spec-temp.class.spec.mfunc:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/user/Desktop/KK-projekat/llvm-project/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running lit suite /home/user/Desktop/KK-projekat/llvm-project/clang/test/CXX/temp/temp.decls/temp.class.spec/temp.class.spec.mfunc"
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/clang/test && /usr/bin/python3.8 /home/user/Desktop/KK-projekat/llvm-project/build/./bin/llvm-lit -sv --param USE_Z3_SOLVER=0 /home/user/Desktop/KK-projekat/llvm-project/clang/test/CXX/temp/temp.decls/temp.class.spec/temp.class.spec.mfunc
...
tools/clang/test/CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class.spec-temp.class.spec.mfunc.dir/clean:
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/clang/test && $(CMAKE_COMMAND) -P CMakeFiles/check-clang-cxx-temp-temp.decls-temp.class.spec-temp.class.spec.mfunc.dir/cmake_clean.cmake
