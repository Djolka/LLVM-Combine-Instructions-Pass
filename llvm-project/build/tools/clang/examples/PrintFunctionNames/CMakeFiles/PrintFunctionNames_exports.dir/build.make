...
tools/clang/examples/PrintFunctionNames/CMakeFiles/PrintFunctionNames_exports: /home/user/Desktop/KK-projekat/llvm-project/clang/examples/PrintFunctionNames/PrintFunctionNames.exports


tools/clang/examples/PrintFunctionNames/PrintFunctionNames.exports: /home/user/Desktop/KK-projekat/llvm-project/clang/examples/PrintFunctionNames/PrintFunctionNames.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/user/Desktop/KK-projekat/llvm-project/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for PrintFunctionNames"
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/clang/examples/PrintFunctionNames && /usr/bin/python3.8 -c "import sys;        lines = ['    ' + l.rstrip() for l in sys.stdin] + ['  local: *;'];        print('LLVM_17 {');        print('  global:') if len(lines) > 1 else None;        print(';\\n'.join(lines) + '\\n};')" < /home/user/Desktop/KK-projekat/llvm-project/clang/examples/PrintFunctionNames/PrintFunctionNames.exports > PrintFunctionNames.exports
...
tools/clang/examples/PrintFunctionNames/CMakeFiles/PrintFunctionNames_exports.dir/clean:
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/clang/examples/PrintFunctionNames && $(CMAKE_COMMAND) -P CMakeFiles/PrintFunctionNames_exports.dir/cmake_clean.cmake
