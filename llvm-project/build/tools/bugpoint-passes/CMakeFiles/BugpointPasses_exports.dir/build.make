...
tools/bugpoint-passes/BugpointPasses.exports: /home/user/Desktop/KK-projekat/llvm-project/llvm/tools/bugpoint-passes/bugpoint.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/user/Desktop/KK-projekat/llvm-project/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for BugpointPasses"
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/bugpoint-passes && /usr/bin/python3.8 -c "import sys;        lines = ['    ' + l.rstrip() for l in sys.stdin] + ['  local: *;'];        print('LLVM_17 {');        print('  global:') if len(lines) > 1 else None;        print(';\\n'.join(lines) + '\\n};')" < /home/user/Desktop/KK-projekat/llvm-project/llvm/tools/bugpoint-passes/bugpoint.exports > BugpointPasses.exports
...
tools/bugpoint-passes/CMakeFiles/BugpointPasses_exports.dir/clean:
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/bugpoint-passes && $(CMAKE_COMMAND) -P CMakeFiles/BugpointPasses_exports.dir/cmake_clean.cmake
