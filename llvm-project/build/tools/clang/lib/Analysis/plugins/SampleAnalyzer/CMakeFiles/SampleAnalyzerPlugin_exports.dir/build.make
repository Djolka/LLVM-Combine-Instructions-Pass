...
tools/clang/lib/Analysis/plugins/SampleAnalyzer/CMakeFiles/SampleAnalyzerPlugin_exports: /home/user/Desktop/KK-projekat/llvm-project/clang/lib/Analysis/plugins/SampleAnalyzer/SampleAnalyzerPlugin.exports


tools/clang/lib/Analysis/plugins/SampleAnalyzer/SampleAnalyzerPlugin.exports: /home/user/Desktop/KK-projekat/llvm-project/clang/lib/Analysis/plugins/SampleAnalyzer/SampleAnalyzerPlugin.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/user/Desktop/KK-projekat/llvm-project/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for SampleAnalyzerPlugin"
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/clang/lib/Analysis/plugins/SampleAnalyzer && /usr/bin/python3.8 -c "import sys;        lines = ['    ' + l.rstrip() for l in sys.stdin] + ['  local: *;'];        print('LLVM_17 {');        print('  global:') if len(lines) > 1 else None;        print(';\\n'.join(lines) + '\\n};')" < /home/user/Desktop/KK-projekat/llvm-project/clang/lib/Analysis/plugins/SampleAnalyzer/SampleAnalyzerPlugin.exports > SampleAnalyzerPlugin.exports
...
tools/clang/lib/Analysis/plugins/SampleAnalyzer/CMakeFiles/SampleAnalyzerPlugin_exports.dir/clean:
	cd /home/user/Desktop/KK-projekat/llvm-project/build/tools/clang/lib/Analysis/plugins/SampleAnalyzer && $(CMAKE_COMMAND) -P CMakeFiles/SampleAnalyzerPlugin_exports.dir/cmake_clean.cmake
