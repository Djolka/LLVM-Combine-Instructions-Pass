# Autogenerated from /home/user/Desktop/KK-projekat/llvm-project/llvm/test/lit.site.cfg.py.in
# Do not edit!
...
config.host_ldflags = ' -fuse-ld=gold'
...
config.llvm_dylib_version = "17git"
